...
export default function Header() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-xl bg-background/95 border-b border-border animate-fade-in-down">
        ...
        <div className="flex items-center justify-between h-20 relative z-10">
          ...
          <div className="flex items-center space-x-4 group cursor-pointer">
            ...
            <div className="flex flex-col group-hover:translate-x-1 transition-transform duration-300">
              <span className="text-xl font-bold font-poppins text-foreground group-hover:text-blue-600 transition-all duration-300 group-hover:tracking-wide">
                FinSight
              </span>
              <span className="text-xs text-muted-foreground font-medium group-hover:text-blue-500 transition-colors duration-300">Finance IA</span>
            </div>
          </div>

          {/* Navigation */}
          <nav className="hidden lg:flex items-center space-x-2">
            <a href="#features" className="relative group px-5 py-2.5 text-sm font-medium text-muted-foreground hover:text-blue-600 transition-colors duration-200">
            ...
            <a href="#about" className="relative group px-5 py-2.5 text-sm font-medium text-muted-foreground hover:text-blue-600 transition-colors duration-200">
              <span className="relative z-10">À propos</span>
              <div className="absolute inset-x-0 bottom-0 h-0.5 bg-gradient-to-r from-transparent via-blue-600 to-transparent scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-center"></div>
              <div className="absolute inset-0 bg-blue-600/5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200"></div>
            </a>
            <a href="#pricing" className="relative group px-5 py-2.5 text-sm font-medium text-muted-foreground hover:text-blue-600 transition-colors duration-200">
              <span className="relative z-10">Tarifs</span>
              <div className="absolute inset-x-0 bottom-0 h-0.5 bg-gradient-to-r from-transparent via-blue-600 to-transparent scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-center"></div>
              <div className="absolute inset-0 bg-blue-600/5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200"></div>
            </a>
            <a href="#contact" className="relative group px-5 py-2.5 text-sm font-medium text-muted-foreground hover:text-blue-600 transition-colors duration-200">
          ...
          <div className="flex items-center space-x-4">
            <Link href="/login">
              <Button variant="ghost" className="hidden md:flex text-muted-foreground hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 font-medium transition-colors duration-200">
                Se connecter
              </Button>
            </Link>
            ...
            {/* Mobile menu button */}
            <Button variant="ghost" size="sm" className="lg:hidden p-2 hover:bg-blue-50 dark:hover:bg-blue-900/20 hover:text-blue-600 transition-colors duration-200">

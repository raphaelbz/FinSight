  ...
  return (
    <footer className="relative bg-muted">
      <div className="max-w-4xl mx-auto px-4 py-20 text-center relative z-10">
        ...
        <p className="text-xl text-muted-foreground font-poppins font-light mb-16 max-w-3xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-12 mb-16 text-center">
          <div>
            <h3 className="font-semibold text-foreground font-poppins mb-4">Sécurité</h3>
          ...
          <div>
            <h3 className="font-semibold text-foreground font-poppins mb-4">Support</h3>
            <div className="space-y-2 text-sm text-muted-foreground">
              <p>FAQ et guides</p>
              <p>Chat 7j/7</p>
          ...
          <div>
            <h3 className="font-semibold text-foreground font-poppins mb-4">Ressources</h3>
            <div className="space-y-2 text-sm text-muted-foreground">
              <p>Blog finance</p>
              <p>Calculateurs</p>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-12 text-muted-foreground font-poppins text-sm">
